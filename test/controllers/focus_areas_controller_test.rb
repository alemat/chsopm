...
class FocusAreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create focus_area" do
    assert_difference('FocusArea.count') do
      post focus_areas_url, params: { focus_area: { description: @focus_area.description, name: @focus_area.name } }
    end
  ...
  test "should update focus_area" do
    patch focus_area_url(@focus_area), params: { focus_area: { description: @focus_area.description, name: @focus_area.name } }
