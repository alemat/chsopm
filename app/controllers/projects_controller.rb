class ProjectsController < ApplicationController
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:user_id, :project_title, :institution_id, :program_area_id, :focus_area_id, :sub_focus_area_id, :project_details, :project_status_id, :acceptance_status, :direct_beneficiaries, :dbt, :ibt, :indirect_beneficiaries, :start_date, :end_date, :total_budget, :program_budget, :admin_budget, :funding_status_id, :reporting_type_id, :project_focal_person, :phone_number, :email, :proposal, :currency, :report_status, funders_attributes: [:id, :project_id, :institution_id, :amount, :currency, :_destroy], implementation_areas_attributes: [:id, :project_id, :region_id, :zone, :district, :contact_person, :phone_number, :email, :_destroy])
    end
end
